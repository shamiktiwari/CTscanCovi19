...
def build_resnet():
    ...
    model.summary()
    return model
CovidResnetmodel = build_resnet()
hist=CovidResnetmodel.fit(x=X_train, y=y_train, batch_size=128, epochs=50, validation_data=[X_cv,y_cv])

final_loss, final_accuracy = CovidResnetmodel.evaluate(X_test, y_test)
print('Final Loss: {}, Final Accuracy: {}'.format(final_loss, final_accuracy))
Y_pred = CovidResnetmodel.predict(data)
