...
X_train, X_1, y_train, y_1 = train_test_split(X_Train, Y_train, test_size=0.3, random_state=27)
...
hist=model.fit(x=X_train, y=y_train, batch_size=128, epochs=100, validation_data=[X_cv,y_cv])
